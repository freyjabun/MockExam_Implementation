...
func (c *incrementServiceClient) Increment(ctx context.Context, in *IncrementRequest, opts ...grpc.CallOption) (*IncrementReply, error) {
...
func (UnimplementedIncrementServiceServer) Increment(context.Context, *IncrementRequest) (*IncrementReply, error) {
